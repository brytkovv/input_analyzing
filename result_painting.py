...
pictures = [(main_input, 'Превышений напряжения в раб. время', 'Превышений напряжения во внераб. время'),
            (reserv_input, 'Превышений напряжения в раб. время', 'Превышений напряжения во внераб. время'),
            (main_input, 'Низкое напряжениев в раб. время', 'Низкое напряжениев во вне раб. время'),
            (reserv_input, 'Низкое напряжениев в раб. время', 'Низкое напряжениев во вне раб. время')]
